...
//	@GetMapping(value = "/members/{aadharNo}")
//	public ResponseEntity<List<Member>> getMembersByAadharNo(@PathVariable Long aadharNo){
//		return new ResponseEntity<List<Member>>(memberService.getMemberByAadharNo(aadharNo), HttpStatus.ACCEPTED);
//	}
//	
