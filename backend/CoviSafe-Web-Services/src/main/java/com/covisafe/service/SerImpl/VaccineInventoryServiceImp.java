...
public class VaccineInventoryServiceImp implements VaccineInventoryService {
	...
	public VaccineInventory addVaccineCount(Integer vaxCenterId ,VaccineInventory inv) {
		...
		if(optional.isEmpty()) throw new VaccineNotFoundException("Vax Center Not Found");
	...
	public VaccineInventory updateVaccineInventory(Integer vaccineInvenId ,  VaccineInventory inv) {
		...
		if(vaccineInvenId==null) throw new VaccineNotFoundException("Please provide Vaccination inventory id to update");
		
		if(inv==null) throw new VaccineNotFoundException("Please provide Vaccination inventory details to update");
	...
	public Boolean deleteVaccinationInventory(Integer vaccineInvenId) {
		if(vaccineInvenId==null) throw new VaccineNotFoundException("Please provide Vaccination inventory id to delete");
	...
	public List<VaccineInventory> getVaccineInventoryByDate(LocalDate date) {
		...
		if(list.size()==0) throw new  VaccineNotFoundException("Vaccine inventory not found on given date");
		return list;
	}
