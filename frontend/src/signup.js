...
form.addEventListener("submit", (e)=>{
 ...
 function ShowNext(user){
    ...
    // nextForm.removeEventListener("submit",getFormData);
    user =  ShowNextNext(user);
    return user;
}

 function ShowNextNext(user){
    ...
    // nextForm2.removeEventListener("submit", getFormData);
    return user;
}
